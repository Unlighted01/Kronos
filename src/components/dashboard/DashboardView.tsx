...
export const DashboardView: React.FC = () => {
  ...
  // Live Pet Stats Query from Dexie IndexedDB
          ...
          <div>
            ...
            <div className="bg-slate-950/50 border border-slate-800 rounded-2xl p-8 text-center flex flex-col items-center justify-center min-h-[360px]">
              ...
              <p className="text-xs text-slate-400 max-w-sm mb-4">
                Your virtual pet lives in your 2D platformer widget. Complete focus timers to earn coins, unlock 2D furniture, and feed your pet snacks!
              </p>
        ...
        {activeTab === 'settings' && (
          <div>
            ...
            <div className="bg-slate-950/50 border border-slate-800 rounded-2xl p-6 space-y-4 max-w-lg">
              ...
              <div className="pt-2">
                <button className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs rounded-xl shadow">
                  Save Preferences
                </button>
              </div>
            </div>
